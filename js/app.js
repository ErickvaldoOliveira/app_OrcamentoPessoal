...
class Bd
{
    ...
    recuperarTodosRegistros()
    {
        ...
        for( let i = 1; i <= id; i++ )
        {
            ...
            //verificando a possibilidade de haver índices que foram pulados/removidos
            //se houver, "pular" os índices
            if( despesa == null )
            {
                continue
            }
...
function carregaListaDespesas( despesas = Array(), filtro = false )
{
    ...
    despesas.forEach( 
        ...
        function( d )
        {
            ...
            //criando um botão de exclusão de despesa
